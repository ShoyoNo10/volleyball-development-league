  ...
  const teams = [
    ...
    },
    {
      ...
      players: [
        ...
        { number: 8, name: "У.Итгэл", position: "" },
        { number: 24, name: "Б.Эрхэм-Итгэл", position: "" },
        { number: 6, name: "Б.Тэмүүлэн", position: "" },
        { number: 20, name: "Ц.Бат-Оргил", position: "" },
        { number: 15, name: "С.Хүлэг", position: "" },
        { number: 14, name: "Э.Мөнхсүлд", position: "" },
        { number: 17, name: "Э.Төгөлдөр", position: "" },
        { number: 9, name: "Х.Тамир", position: "" },
        { number: 22, name: "Э.Пүрэв-Очир", position: "" },
        { number: 25, name: "Д.Тэргэл", position: "" },
        { number: 5, name: "Г.Ариунболд", position: "" },
      ],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      players: [
        ...
        { number: 3, name: "М.Энхэмбаяр", position: "Голын хаагч" },
